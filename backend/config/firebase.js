...
// Firebase initialization completely disabled
...
console.log("Firebase Admin SDK is disabled");

// Export mock messaging object
export const messaging = {
    send: async () => console.log("Firebase disabled: Would send notification"),
    sendMulticast: async () => console.log("Firebase disabled: Would send multicast")
};
