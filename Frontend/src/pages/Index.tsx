...
//   const [userName, setUserName] = useState("Test User"); // Hardcoded for easier testing
//   const [userInitials, setUserInitials] = useState("TU"); // Hardcoded for easier testing
//   const [loading, setLoading] = useState(false); // Set to false to skip loading state

//   // --- HARDCODED TEST DATA HERE ---
//   const [scanResults, setScanResults] = useState<{
//     eye: { score: number | null; updatedAgo: string };
//     teeth: { score: number | null; updatedAgo: string };
//     skin: { score: number | null; updatedAgo: string };
//   }>({
//     // Test Case: Good Status (>= 70) -> Green
//     eye: { score: 60, updatedAgo: "3 hours ago" },
//     // Test Case: Moderate Status (40-69) -> Orange
//     teeth: { score: 55, updatedAgo: "1 day ago" },
//     // Test Case: Critical Status (< 40) -> Red
//     skin: { score: 20, updatedAgo: "10 minutes ago" },
//   });

//   const [overallScore, setOverallScore] = useState(60); // (90 + 55 + 20) / 3 ≈ 55
//   const [totalScans, setTotalScans] = useState(3);
//   const [lastScanDate, setLastScanDate] = useState("Today");
//   // --- END HARDCODED TEST DATA ---

//   // NOTE: Commented out useEffect to stop API call from overwriting test scores.
//   /*
//   useEffect(() => {
...
//   // NOTE: Removed fetchDashboardData and getTimeAgo since we are hardcoding the test data.
//   // They can be uncommented/restored once testing is complete.
//   const fetchDashboardData = async () => {
//     /* API call disabled for testing */
//   };
//   const getTimeAgo = (date: Date) => {
//     /* Function disabled for testing */
//   };
