            ...
            <div className="bg-primary/5 py-12">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <p className="text-lg text-muted-foreground">
                        Learn how to get the most out of ScanMed.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 max-w-4xl py-12 space-y-16">
                <section className="scroll-mt-20">
                    <div className="prose dark:prose-invert max-w-none space-y-4 text-muted-foreground">
                        <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Getting Started</h3>
                        <p>
                            Welcome to ScanMed! This guide will help you navigate the platform and use our features effectively.
                        </p>
                        <h4 className="font-semibold mt-4">1. Creating an Account</h4>
                        <p>
                            Sign up using your email and password. Ensure you verify your email address to access full features.
                        </p>
                        <h4 className="font-semibold mt-4">2. Uploading Scans</h4>
                        <p>
                            Navigate to the "Scan" tab to upload your medical imaging files (MRI, CT, X-Ray). Our AI will analyze them and provide insights.
                        </p>
                    </div>
                </section>
            </div>
